...
struct printer_ops_s {
	...
	void (*page_prologue) (struct printer_state_s *state, const struct page_dims_s *dims);
	void (*page_epilogue) (struct printer_state_s *state, const struct page_dims_s *dims);
